...
<html lang="en">
  ...
  <head>
    ...
    <title>JobRows - Offer a Sevice</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Offer a Sevice
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Offer a Sevice</li>
      </ol>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        <input id="title" name="title" type="text" placeholder="Offer Title" class="form-control input-md" required="">
      ...
      <?php
      	if(isset($_POST['b1']))
      	{
      		...
      		$cat=$_POST['category'];
      		$user=$_SESSION['user'];
      		$res3=mysqli_query($link,"INSERT INTO offer values ('','$title','$des',CURRENT_TIMESTAMP(),1,'$user','$gov','$cat');");
      		if($res3)
      		{
      			echo '<script>alert("Your offer has been posted!");</script>';
