...
<html lang="en">
  ...
  <head>
    ...
    <title>JobRows - Demand Respond</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Demand Respond
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Demand Respond</li>
      </ol>
      <?php
      ...
      $res1=mysqli_query($link,"SELECT* FROM demand_comment WHERE fake_user_id='$fakeuserid' AND id='$id';");
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="card mt-4">
            <div class="card-body">
              <h3 class="card-title">user_<?php echo $fakeuserid; ?> <small>offered to do the job for <?php echo $price ?></small></h3>
            ...
            <form class="form-horizontal" name="f1" action="" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <a href="demanddeal.php?id=<?php echo $id; ?>&fakeuser= <?php echo $fakeuserid; ?>"><button id="b1" name="b1" class="btn btn-success" type="button">Accept</button></a>
