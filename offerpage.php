...
<html lang="en">
  ...
  <head>
    ...
    <title>JobRows - Offer Page</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="postoffer.php">Demand a Job</a>
            </li>
            <?php
            if(!isset($_SESSION['log']))
            {
    ...
    <div class="container">
      ...
      {
      $id=$_GET['offer'];
      $res1=mysqli_query($link,"SELECT* FROM offer WHERE id='$id';");
      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card card-outline-secondary my-4">
            ...
            <?php
            $res2=mysqli_query($link,"SELECT* FROM offer_comment WHERE id_offer='$id' ORDER BY date_time DESC");
            ...
            $user=$raw2['id_user']; ?>
              <small class="text-muted">user_<?php echo $fakeuser; ?> asked for the service for <strong><?php echo $price ?> TND </strong> on <?php echo $time; ?></small>
              <p><?php echo $content; ?></p>
              <?php
                if(strcmp($_SESSION['user'], $user)==0 AND $open==1)
                {
                  echo '<p><strong><a href="offerrespond.php?fakeuser=' . $fakeuser . '&id=' . $id . '">Respond</a></strong></p>';
                }
              ?>
              <hr>
              <?php
              ...
              else
              {
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <button class="btn btn-danger">This offer is Closed</button>
                  </div>
                </div>
                <?php
              }
    ...
    if(isset($_POST['b1']))
    {
      ...
      $res3=mysqli_query($link,"SELECT* FROM offer_comment WHERE id_offer='$id_offer' AND id_user='$user'");
      if(mysqli_num_rows($res3)!=0)
      {
        $raw3=mysqli_fetch_array($res3);
        $fakeuser=$raw3['fake_user_id'];
        $res4=mysqli_query($link,"INSERT INTO offer_comment VALUES('','$ammount','$content','$id_offer','$user','$fakeuser',CURRENT_TIMESTAMP());");
        if(!$res4)
      ...
      else
      {
        ...
        $res5=mysqli_query($link,"INSERT INTO offer_comment VALUES('','$ammount','$content','$id_offer','$user',$fakeuser,CURRENT_TIMESTAMP());");
        if(!$res5)
